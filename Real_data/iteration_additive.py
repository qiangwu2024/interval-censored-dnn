...
def Est_additive(Z_train,X_train,U_train,V_train,De1_train,De2_train,De3_train,X_test,X_sort1,X_sort0,Beta0,nodevec,m,c0,m0,nodevec0):
    Lambda_U = I_S(m, c0, U_train, nodevec)
    Lambda_V = I_S(m, c0, V_train, nodevec)
    C_index = 0
    for loop in range(50):
        print('additive_iteration time=', loop)
        g_X = g_A(Z_train,X_train,De1_train,De2_train,De3_train,X_test,X_sort1,X_sort0,Lambda_U,Lambda_V,Beta0,m0,nodevec0)
        g_train = g_X['g_train']
