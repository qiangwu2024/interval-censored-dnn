...
def Ic_inte_basis(j, m, u, nodevec):
    if (j==0):
        if (nodevec[0]<=u) and (u<nodevec[1]):
            result = ((nodevec[1]-nodevec[0])**3-(nodevec[1]-u)**3)/(3*(nodevec[1]-nodevec[0])**2)
        else:
            result = (nodevec[1]-nodevec[0])/3
        return result
    elif (j==1):
        if (nodevec[0]<=u) and (u<nodevec[1]):
            result = 2/3*(((-u**3/3+(u**2*(nodevec[0]+nodevec[2])/2-nodevec[0]*nodevec[2]*u))-(-nodevec[0]**3/3+(nodevec[0]**2*(nodevec[0]+nodevec[2])/2-nodevec[0]**2*nodevec[2])))/((nodevec[1]-nodevec[0])*(nodevec[2]-nodevec[1])))
        elif (nodevec[1]<=u) and (u<nodevec[2]):
            result = 2/3*(((-nodevec[1]**3/3+(nodevec[1]**2*(nodevec[0]+nodevec[2])/2-nodevec[0]*nodevec[2]*nodevec[1]))-(-nodevec[0]**3/3+(nodevec[0]**2*(nodevec[0]+nodevec[2])/2-nodevec[0]**2*nodevec[2])))/((nodevec[1]-nodevec[0])*(nodevec[2]-nodevec[1]))+((nodevec[2]-nodevec[1])**3-(nodevec[2]-u)**3)/(3*(nodevec[2]-nodevec[1])**2))
        else:
            result = 2/3*(((-nodevec[1]**3/3+(nodevec[1]**2*(nodevec[0]+nodevec[2])/2-nodevec[0]*nodevec[2]*nodevec[1]))-(-nodevec[0]**3/3+(nodevec[0]**2*(nodevec[0]+nodevec[2])/2-nodevec[0]**2*nodevec[2])))/((nodevec[1]-nodevec[0])*(nodevec[2]-nodevec[1]))+(nodevec[2]-nodevec[1])/3)
        return result
    elif (j==2):
        if (nodevec[m-1]<=u) and (u<nodevec[m]):
            result = 2/3*((u-nodevec[m-1])**3/(3*(nodevec[m]-nodevec[m-1])**2))
        elif (nodevec[m]<=u) and (u<=nodevec[m+1]):
            result = 2/3*((nodevec[m]-nodevec[m-1])/3+((-u**3/3+(u**2*(nodevec[m-1]+nodevec[m+1])/2-nodevec[m-1]*nodevec[m+1]*u))-(-nodevec[m]**3/3+(nodevec[m]**2*(nodevec[m-1]+nodevec[m+1])/2-nodevec[m-1]*nodevec[m+1]*nodevec[m])))/((nodevec[m]-nodevec[m-1])*(nodevec[m+1]-nodevec[m])))
        else:
            result = 0
        return result
    elif (j==3):
        if (nodevec[m]<=u) and (u<=nodevec[m+1]):
            result = (u-nodevec[m])**3/(3*(nodevec[m+1]-nodevec[m])**2)
        else:
            result = 0
        return result
